...
/**
 * Custom Bricks element: ETP Rich Text.
 */
...
if (!class_exists('\Bricks\Element')) {
  error_log('ETP Text: Bricks\\Element not available.');
  return;
}

class ETP_Text extends \Bricks\Element
{
  public $block    = ['core/paragraph', 'core/list'];
  public $category = 'etp';
  public $name     = 'etp-text';
  public $icon     = 'ti-align-left';

  public function get_label()
  {
    return esc_html__('ETP Rich Text', 'etp');
  }
  ...
  public function render()
  {
    ...
    // Add element-specific root class.
    $this->set_attribute('_root', 'class', 'etp-text brxe-container');
  ...
  { ?>
    <script type="text/x-template" id="tmpl-bricks-element-etp-text">
      <contenteditable
        :name="name"
        controlKey="text"
        toolbar="true"
